...
if ( function_exists( 'add_image_size' ) ) {
	...
	add_image_size( 'name', 347, 299, true );

	add_image_size( 'medium', 400, 9999, false );

	add_image_size( 'col2', 178, 9999, false );
	add_image_size( 'col3', 278, 9999, false );
	add_image_size( 'col4', 378, 9999, false );

	add_image_size( 'home', 178, 220, false );

	add_image_size( 'essay', 378, 378, false );
}
...
function alter_query($query) {
    ...
    if ( $query->is_post_type_archive('essay') ) {
	    $query-> set('order' ,'ASC');
    }
